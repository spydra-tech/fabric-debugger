...
import { ResourcesTreeProvider } from './providers/ResourcesTreeProvider';
...
export async function activate(context: vscode.ExtensionContext): Promise<void> {
	...
	context.subscriptions.push(vscode.commands.registerCommand('hlf.localnetwork.start', () => HlfProvider.createNetwork()));
	...
	context.subscriptions.push(vscode.commands.registerCommand('hlf.fabric.request', ((range: vscode.Range) => new HlfRequestCommandProvider().exec(range))));
	...
	context.subscriptions.push(vscode.commands.registerCommand('hlf.identity.create', () => walletIdentityProvider.createIdentity()));
	context.subscriptions.push(vscode.commands.registerCommand('hlf.identity.remove', (element: WalletItem) => walletIdentityProvider.removeIdentity(element)));
	context.subscriptions.push(vscode.commands.registerCommand('hlf.identity.refresh', () => walletTreeProvider.refresh()));
