...
function createOrg1() {
  ...
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-5054-ca-org1.pem
  ...
  OrdererOUIdentifier:
    Certificate: cacerts/localhost-5054-ca-org1.pem
    OrganizationalUnitIdentifier: orderer' > "${PWD}/organizations/peerOrganizations/org1.debugger.com/msp/config.yaml"
  ...
  mkdir -p "${PWD}/organizations/peerOrganizations/org1.debugger.com/msp/tlscacerts"
  cp "${PWD}/organizations/fabric-ca/org1/ca-cert.pem" "${PWD}/organizations/peerOrganizations/org1.debugger.com/msp/tlscacerts/ca.crt"

  # Copy org1's CA cert to org1's /tlsca directory (for use by clients)
  mkdir -p "${PWD}/organizations/peerOrganizations/org1.debugger.com/tlsca"
  cp "${PWD}/organizations/fabric-ca/org1/ca-cert.pem" "${PWD}/organizations/peerOrganizations/org1.debugger.com/tlsca/tlsca.org1.debugger.com-cert.pem"
  ...
  cp "${PWD}/organizations/peerOrganizations/org1.debugger.com/peers/peer0.org1.debugger.com/tls/tlscacerts/"* "${PWD}/organizations/peerOrganizations/org1.debugger.com/peers/peer0.org1.debugger.com/tls/ca.crt"
...
function createOrg2() {
  ...
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-5064-ca-org2.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/localhost-5064-ca-org2.pem
    OrganizationalUnitIdentifier: peer
  ...
  OrdererOUIdentifier:
    Certificate: cacerts/localhost-5064-ca-org2.pem
    OrganizationalUnitIdentifier: orderer' > "${PWD}/organizations/peerOrganizations/org2.debugger.com/msp/config.yaml"

  # Since the CA serves as both the organization CA and TLS CA, copy the org's root cert that was generated by CA startup into the org level ca and tlsca directories

  # Copy org2's CA cert to org2's /msp/tlscacerts directory (for use in the channel MSP definition)
  mkdir -p "${PWD}/organizations/peerOrganizations/org2.debugger.com/msp/tlscacerts"
  cp "${PWD}/organizations/fabric-ca/org2/ca-cert.pem" "${PWD}/organizations/peerOrganizations/org2.debugger.com/msp/tlscacerts/ca.crt"

  # Copy org2's CA cert to org2's /tlsca directory (for use by clients)
  mkdir -p "${PWD}/organizations/peerOrganizations/org2.debugger.com/tlsca"
  cp "${PWD}/organizations/fabric-ca/org2/ca-cert.pem" "${PWD}/organizations/peerOrganizations/org2.debugger.com/tlsca/tlsca.org2.debugger.com-cert.pem"
  ...
  # Copy the tls CA cert, server cert, server keystore to well known file names in the peer's tls directory that are referenced by peer startup config
  cp "${PWD}/organizations/peerOrganizations/org2.debugger.com/peers/peer0.org2.debugger.com/tls/tlscacerts/"* "${PWD}/organizations/peerOrganizations/org2.debugger.com/peers/peer0.org2.debugger.com/tls/ca.crt"
