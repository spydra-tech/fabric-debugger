...
if peer lifecycle chaincode querycommitted -C default | grep -q "Name: $1,"; then
    ...
    peer lifecycle chaincode approveformyorg -o orderer.debugger.com:5050 --channelID default --name $1 --version $2 --sequence 1 --signature-policy "OR ('Org1MSP.member')" --package-id $3
